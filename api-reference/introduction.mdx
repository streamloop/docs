...
<Note>
  The REST endpoint pages in this section are generated from Streamloop's
  [OpenAPI document](https://api.streamloop.app/v1/openapi.json) — the same contract the API is built from. The live spec is always available at that URL.
</Note>
